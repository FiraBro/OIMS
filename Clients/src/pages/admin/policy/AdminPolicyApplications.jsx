    ...
    <>
                          ...
                          <div className="space-y-3">
                            <div className="flex gap-2">
                              ...
                              <Button
                                ...
                                variant="outline"
                                className="flex-1 text-rose-700 border-rose-300 hover:bg-rose-50 hover:border-rose-400"
                              >
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            document
                              .querySelector('[data-value="documents"]')
                              ?.click()
                          }
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <p className="text-gray-600">
                          All submitted documents for verification. Click any
                          document to preview.
                        </p>
                        ...
                        {(!selectedApp.documents ||
                          ...
                          <div className="text-center py-8">
                            ...
                            <p className="text-gray-500">
                              The applicant has not submitted any documents yet.
                            </p>
                          </div>
                        )}
                      </div>
      ...
      <Dialog open={!!selectedDoc} onOpenChange={() => setSelectedDoc(null)}>
        <DialogContent className="max-w-4xl bg-white">
          ...
          <div className="relative rounded-lg overflow-hidden border border-gray-200 bg-gray-50 p-4">
            <img
              src={`/${selectedDoc}`}
              alt="Document"
